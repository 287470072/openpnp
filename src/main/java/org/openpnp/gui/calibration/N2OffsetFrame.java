...
public class N2OffsetFrame extends JFrame {
    ...
    public void createUi() {
        ...
        JLabel descryption = new JLabel(Translations.getString("N2.Offset.Frame.Descryption"));
        ...
        calibrateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                UiUtils.submitUiMachineTask(() -> {
                    ...
                    ReferenceNozzle nozzle = (ReferenceNozzle) Configuration.get().getMachine().getHeads().get(0).getNozzles().get(1);
