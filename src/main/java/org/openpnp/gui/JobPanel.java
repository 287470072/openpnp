...
public class JobPanel extends JPanel {
    ...
    public void jobStart2() throws Exception {
        this.jobProcessor = (JobProcessor) Configuration.get().getMachine().getPnpJobProcessor();
        if (isAllPlaced()) {
        ...
        this.jobProcessor.initialize(this.job);
        jobRun();
    }
    ...
    public void stop() {
        UiUtils.messageBoxOnException(() -> this.stopJobAction.actionPerformed(null));
    }
